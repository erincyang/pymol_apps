...
def alignwithanymethod(mobile, target, methods='align super cealign tmalign', async=1, quiet=1):
    '''
DESCRIPTION
...
def tmalign(mobile, target, args='', exe='/Users/natteruw/pymolscripts/TMalign', ter=0, transform=1, object=None, quiet=0):
    '''
DESCRIPTION
