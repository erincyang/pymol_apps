...
#start_rosetta_server('0.0.0.0', 65000)

# To use PyMOLPyRosettaServer.py over a network, uncomment the line below and
# set the first argument to your IP address:
#start_rosetta_server('10.199.130.113', 65000)
#start_rosetta_server('128.95.160.135', 65000)
start_rosetta_server('10.155.190.122', 65000)
