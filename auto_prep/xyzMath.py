...
def randrot(n=1):
 	if n is 1: return rotation_matrix_degrees(randnorm(),uniform(0,1)*360)
...
def align_skew_line_pairs(aa1,ac1,aa2,ac2,ba1,bc1,ba2,bc2):
	...
	>>> ba2 = Uy
	>>> bc2 = V0
	>>> align_skew_line_pairs(aa1,ac1,aa2,ac2,ba1,bc1,ba2,bc2)
...
def rotation_around_dof_to_set_vec_vec_angle(dofaxis,tgt0,v1,v2):
	...
	ret0 = []
	for tgt in (tgt0%360,(180-tgt0)%360):
